...
public:		//	Operations
	...
	bool SetLoadCenter(const A3DVECTOR3& vCenter, bool bNoUnload = false);
...
#else
	A3DGrassType* GetGlassType(DWORD dwType);
#endif
...
#ifndef BACK_VERSION
	DWORD  GetPostEffectFlag() const { return m_dwPostEffectFlag; }
	...
	const A3DPOST_EFFECT_CC_PARAM& GetPostEffectCCParamDay() const { return m_EffectCCDay; }
	const A3DPOST_EFFECT_CC_PARAM& GetPostEffectCCParamNight() const { return m_EffectCCNight; }
#endif
	...
	void LoadBlockResByPos(A3DVECTOR3 vPos);
...
protected:	//	Attributes
...
#ifndef BACK_VERSION
	float m_fLightMapMaxLight;			//	Environment parematers
	...
	A3DPOST_EFFECT_CC_PARAM			m_EffectCCDay;
	A3DPOST_EFFECT_CC_PARAM			m_EffectCCNight;
#endif
...
protected:	//	Operations
	...
	void CheckObjectIDCollision(int iType, DWORD id);
