...
public:		//	Operations
	...
	bool UpdateRes(float fDist, bool bNoDelete = false);

	//	Get block area in world
	const ARectF& GetBlockArea() { return m_rcBlock; }

#ifndef BACK_VERSION
	DWORD GetPostEffectFlag() const { return m_dwEffectFlag; }
...
protected:	//	Attributes
	...
	ECWDFILEBLOCK16				m_Info;				//	Block information
	...
	A3DPOST_EFFECT_WARP_PARAM		m_EffectWarp;
