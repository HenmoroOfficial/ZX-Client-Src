...
namespace SimpleDB
{
template<typename TValueType> struct Field;

template<typename ValueType>
bool operator == (const ValueType &value, const Field<ValueType> & field);

template<typename ValueType>
bool operator == (const Field<ValueType> & field, const ValueType &value);

template<typename ValueType>
bool operator == (const DBNull &value, const Field<ValueType> & field);

template<typename ValueType>
bool operator == (const Field<ValueType> & field, const DBNull &value);
...
// 	template<typename ValueType>
// 	inline bool operator == (const ValueType &value, const Field<ValueType> & field)
// 	{
// 		if (field.IsNull())
// 			return false;
// 		else
...
// 	}
// 	template<typename ValueType>
// 	inline bool operator == (const Field<ValueType> & field, const ValueType &value)
// 	{
// 		return value == field;
// 	}
	
// 	template<typename ValueType>
// 	inline bool operator == (const DBNull &value, const Field<ValueType> & field)
// 	{
// 		return field.IsNull();
// 	}
// 	template<typename ValueType>
// 	inline bool operator == (const Field<ValueType> & field, const DBNull &value)
// 	{
// 		return value == field;
// 	}
