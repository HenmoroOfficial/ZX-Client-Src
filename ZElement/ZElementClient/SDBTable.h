...
namespace TablePrivate
{
	...
	public:
		typedef typename TypeList<typename HeadReplacedTypeList::Head, typename StructureTypeList2FieldStrNameValueListHelper<typename HeadReplacedTypeList::Tail>::Result> Result;
	};
	...
	{
		typedef typename ValueList<typename StructureTypeList2FieldStrNameValueListHelper<typename TTypeList>::Result> Result;
	};
}
...
public:
	...
	typedef typename Table<TTypeList, FirstNFieldIsPrimaryKey, DBFileName> ThisType;
	typedef typename Record<TTypeList> RecordType;
	...
	typedef typename ValueList<PrimaryKeyTypeList> PrimaryKeyValueList;
...
private:
	...
	public:
		typedef typename TypeList<typename HeadTableType::RecordType, typename FromTablesTypeList2FromRecordsTypeList<typename TailTalbeType>::Result > Result;
	};
...
public:
	...
	typedef typename ValueList<FromTablesPtrTypeList> FromTablesPtrValueList;
	typedef typename ValueList<FromTablesConstPtrTypeList> FromTablesConstPtrValueList;
	...
	typedef typename ValueList<FromRecordsPtrTypeList> FromRecordsPtrValueList;
	typedef typename ValueList<FromRecordsConstPtrTypeList> FromRecordsConstPtrValueList;
...
namespace TablePrivate
{
	...
	*/
	...
	private:
		...
		typedef typename ValueList<typename TL::TypeList2ConstPtrTypeList<TFromTablesTypeList>::Result> FromTablesConstPtrValueList;
		typedef typename SelectFromHelperTypeGenerator<TFromTablesTypeList> TypeGenerator;
...
//	_CrtDbgReport(_CRT_WARN, NULL, 0, NULL, "Enter SelectFrom()\n");
	typedef SelectFromHelperTypeGenerator<TFromTablesTypeList>::FromRecordsConstPtrValueList FullFromRecordsConstPtrValueList;
	FullFromRecordsConstPtrValueList fullFromRecordsConstPtr;
	TablePrivate::
...
inline void SelectFrom(
	...
	TResultTable & resultTable)
{
	typedef TL::TypeListGenerator1<TTable>::Result SingleTableTypeList;
	typedef SelectFromHelperTypeGenerator<SingleTableTypeList>::FromTablesConstPtrValueList SingleTableValueList;
