...
public:		//	Operations
	...
	//	Render routine
	bool Render(CECViewport* pViewport, bool bPortrait, bool bHighLight);
	...
	//	change textures
	bool ChangeFaceTexture(const char * szBaseTex, const char * szHighTex);
...
protected:	//	Attributes
	...
	A3DSkinModel*	m_pSkinModel;	//	A3D skin model object
...
protected:
	...
	static CExpression 			m_Expressions[8][2][FACE_ANIMATION_MAX];	// all expression for all races
