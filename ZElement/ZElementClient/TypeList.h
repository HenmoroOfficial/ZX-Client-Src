...
{
	typedef typename TypeList<typename TTypeList::Head *, typename TypeList2PtrTypeList<typename TTypeList::Tail>::Result> Result;
};
...
{
	typedef typename TypeList<const typename TTypeList::Head *, typename TypeList2ConstPtrTypeList<typename TTypeList::Tail>::Result> Result;
};
