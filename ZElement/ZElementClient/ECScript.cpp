...
#define TOKEN_PRECOMPILE_NO_DISABLE	"no_disable"
...
bool CECScriptFile::Open(AString strFileName)
{
	...
	return m_pFile->Open(strFileName, AFILE_OPENEXIST | AFILE_TEXT | AFILE_NOHEAD | AFILE_TEMPMEMORY);
}
...
void CECScriptParser::ParsePrecompileSymbol(CECScript *pScript)
{
	...
	do
	{
		...
		else if (GetToken() == TOKEN_PRECOMPILE_NO_DISABLE)
		{
			pScript->m_bNoDisable = true;
		}
