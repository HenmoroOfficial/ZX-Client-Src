...
#define ISKEYPRESSED(k)	((GetAsyncKeyState(k) & 0x8000) ? true : false)
#define ISKEYTOGGLED(k)	((GetAsyncKeyState(k) & 0x0001) ? true : false)
...
public:		//	Operations
	...
	//	Is first pressed ?
	static bool IsFirstPressed(DWORD dwFlags) { return (dwFlags & EC_KSF_FIRSTPRESS) ? true : false; }
	...
	CECInputFilter* GetKBFilter() { return PeekKBFilter(); }
	CECInputFilter* GetMouFilter() { return PeekMouFilter(); }
