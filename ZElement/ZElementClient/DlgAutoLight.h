...
protected:
	...
	AUISlider* m_pSliderDayFogStart;
	AUISlider* m_pSliderDayFogEnd;
	AUISlider* m_pSliderNightFogStart;
	AUISlider* m_pSliderNightFogEnd;

	AUILabel* m_pLabelDayFogStart;
	AUILabel* m_pLabelDayFogEnd;
	AUILabel* m_pLabelNightFogStart;
	AUILabel* m_pLabelNightFogEnd;

	int m_nDayFogStart;
	int m_nDayFogEnd;
	int m_nNightFogStart;
	int m_nNightFogEnd;
...
protected:
	...
	void OnCommandOpenChooseDaySunColor(const char* szCommand);
	void OnCommandOpenChooseDayEnvironmentColor(const char* szCommand);
	void OnCommandOpenChooseDayFogColor(const char* szCommand);
	void OnCommandOpenChooseNightSunColor(const char* szCommand);
	void OnCommandOpenChooseNightEnvironmentColor(const char* szCommand);
	void OnCommandOpenChooseNightFogColor(const char* szCommand);

	void OnCommandCreateLightMap(const char* szCommand);
