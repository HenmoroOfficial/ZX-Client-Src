...
protected:
	...
	AUIEditBox *		m_pTxtRestSP;
	AUIImagePicture *	m_pSkillIcon[CDLGTEACH_TEACHS_PP];
	AUIEditBox *		m_pSkillName[CDLGTEACH_TEACHS_PP];
	AUIEditBox *		m_pSkillLevel[CDLGTEACH_TEACHS_PP];
	AUIEditBox *		m_pSkillCostSP[CDLGTEACH_TEACHS_PP];
	AUIEditBox *		m_pSkillCostMoney[CDLGTEACH_TEACHS_PP];
