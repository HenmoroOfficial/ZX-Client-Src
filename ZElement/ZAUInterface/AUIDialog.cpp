...
int AUIDialog::GetType(void)
{
	return m_nType;
}

void AUIDialog::SetType(int nType)
{
	m_nType = nType;
}
...
const char * AUIDialog::GetName(void)
{
	return m_szName;
}
...
const ACHAR * AUIDialog::GetText(void)
{
	return m_strTitle;
}

void AUIDialog::SetText(const ACHAR *pszText)
{
	m_strTitle = pszText;
}
...
void AUIDialog::SetIsDefaultShow(bool bShow)
{
	m_bDefaultShow = bShow;
}

bool AUIDialog::IsDefaultShow(void)
{
	return m_bDefaultShow;
}

void AUIDialog::SetIsModal(bool bModal)
{
	m_bModal = bModal;
}

bool AUIDialog::IsModal(void)
{
	return m_bModal;
}

bool AUIDialog::IsCapture(void)
{
	return m_bCapture;
}
...
void AUIDialog::SetCommand(const char *pszCommand)
{
...
PAUIOBJECTLISTELEMENT AUIDialog::GetFirstControl(void)
{
	return m_pListHead;
}

PAUIOBJECTLISTELEMENT AUIDialog::GetNextControl(PAUIOBJECTLISTELEMENT pThis)
{
	ASSERT(pThis);
	return pThis->pNext;
}

PAUIOBJECTLISTELEMENT AUIDialog::GetLastControl(void)
{
	return m_pListTail;
}

PAUIOBJECTLISTELEMENT AUIDialog::GetPrevControl(PAUIOBJECTLISTELEMENT pThis)
{
	ASSERT(pThis);
	return pThis->pLast;
}
...
int AUIDialog::GetAlpha(void)
{
	return m_nAlpha;
}

void AUIDialog::SetAlpha(int nAlpha)
{
	ASSERT(nAlpha >= 0 && nAlpha <= 255);
	m_nAlpha = nAlpha;
}

int AUIDialog::GetWholeAlpha(void)
{
	return m_nWholeAlpha;
}

void AUIDialog::SetWholeAlpha(int nWholeAlpha)
{
	ASSERT(nWholeAlpha >= 0 && nWholeAlpha <= 255);
	m_nWholeAlpha = nWholeAlpha;
}

void AUIDialog::SetA3DEngine(A3DEngine *pA3DEngine)
{
	ASSERT(pA3DEngine);
	m_pA3DEngine = pA3DEngine;
}

void AUIDialog::SetA3DDevice(A3DDevice *pA3DDevice)
{
	ASSERT(pA3DDevice);
	m_pA3DDevice = pA3DDevice;
}

AUIManager * AUIDialog::GetAUIManager()
{
	return m_pAUIManager;
}

void AUIDialog::SetAUIManager(AUIManager *pAUIManager)
{
	ASSERT(pAUIManager);
...
void AUIDialog::SetImageCoverOrderly(bool bOrderly)
{
	m_bImageCoverOrderly = bOrderly;
}

bool AUIDialog::GetImageCoverOrderly()
{
	return m_bImageCoverOrderly;
}

int AUIDialog::GetCurImageCover()
{
	return m_nCurImageCover;
}

AUISubDialog * AUIDialog::GetParentDlgControl()
{
	return m_pParentDlgControl;
}

void AUIDialog::SetParentDlgControl(AUISubDialog *pAUISubDialog)
{
	m_pParentDlgControl = pAUISubDialog;
}

const char * AUIDialog::GetFilename(void)
{
	return m_szFilename;
}
...
bool AUIDialog::GetDestroyFlag()
{
	return m_bDestroyFlag;
}

void AUIDialog::SetDestroyFlag(bool bFlag)
{
	m_bDestroyFlag = bFlag;
}
...
bool AUIDialog::IsBackgroundDialog()
{
	return m_bBackgroundDialog;
}
...
bool AUIDialog::IsCanMove()
{
	return m_bCanMove;
}

void AUIDialog::SetCanMove(bool bCanMove)
{
	m_bCanMove = bCanMove;
}

bool AUIDialog::IsCanChangeZOrder()
{
	return m_bCanChangeZOrder;
}

void AUIDialog::SetCanChangeZOrder(bool bCanChangeZOrder)
{
	m_bCanChangeZOrder = bCanChangeZOrder;
}

PAUIOBJECT AUIDialog::GetCaptureObject()
{
	return m_pObjCapture;
}

void AUIDialog::SetCaptureObject(PAUIOBJECT pObject)
{
	m_pObjCapture = pObject;
}

bool AUIDialog::IsCanOutOfWindow()
{
	return m_bCanOutOfWindow;
}

void AUIDialog::SetCanEscClose(bool bCanEsc)
{
	m_bCanEscClose = bCanEsc;
}

bool AUIDialog::IsCanEscClose()
{
	return m_bCanEscClose;
}
...
void AUIDialog::SetCanOutOfWindow(bool bCanOut)
{
	m_bCanOutOfWindow = bCanOut;
}
...
void AUIDialog::SetNoFlush(bool bNoFlush)
{
	m_bNoFlush = bNoFlush;
}

PAUIFRAME AUIDialog::GetFrame()
{
	return m_pAUIFrameDlg;
}

void AUIDialog::Blink(int nInterval)
{
	m_nBlinkInterval = nInterval;
}

int AUIDialog::GetFileVersion()
{
	return m_nFileVersion;
}

bool AUIDialog::IsEnabled()
{
	return m_bEnabled;
}

void AUIDialog::SetEnable(bool bEnable)
{
	m_bEnabled = bEnable;
}

bool AUIDialog::IsPopup()
{
	return m_bPopup;
}

void AUIDialog::SetPopup(bool bPopup)
{
	m_bPopup = bPopup;
}
...
void AUIDialog::UpdateRenderTarget()
{
...
void AUIDialog::SetMinDistDlgBToScrT(int iDist)
{
	m_nMinDistDlgBToScrT = iDist;
}

void AUIDialog::SetMinDistDlgLToScrR(int iDist)
{
	m_nMinDistDlgLToScrR = iDist;
}

void AUIDialog::SetMinDistDlgRToScrL(int iDist)
{
	m_nMinDistDlgRToScrL = iDist;
}

void AUIDialog::SetMinDistDlgTToScrB(int iDist)
{
	m_nMinDistDlgTToScrB = iDist;
}


int AUIDialog::GetMinDistDlgBToScrT()
{
	return m_nMinDistDlgBToScrT;
}

int AUIDialog::GetMinDistDlgLToScrR()
{
	return m_nMinDistDlgLToScrR;
}

int AUIDialog::GetMinDistDlgRToScrL()
{
	return m_nMinDistDlgRToScrL;
}

int AUIDialog::GetMinDistDlgTToScrB()
{
	return m_nMinDistDlgTToScrB;
}
