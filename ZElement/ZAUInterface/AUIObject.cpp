...
void AUIObject::SetPos(int x, int y)
{
	...
	{
		m_x = x;
		m_nDefaultX = x / fWindowScale;
	}
	if( y != m_y )
	{
		m_y = y;
		m_nDefaultY = y / fWindowScale;
	}
}

const char * AUIObject::GetName(void)
{
	return m_szName;
}
...
bool AUIObject::IsShow(void)
{
	return m_bShow;
}

int AUIObject::GetState(void)
{
	return m_nState;
}

void AUIObject::SetState(int nState)
{
	m_nState = nState;
}

AUIDialog * AUIObject::GetParent(void)
{
	return m_pParent;
}

void AUIObject::SetParent(AUIDialog * pParent)
{
	ASSERT(pParent);
	m_pParent = pParent;
}

bool AUIObject::IsEnabled(void)
{
	return m_bEnabled;
}
...
int AUIObject::GetType(void) const
{
	return m_nType;
}
...
A3DCOLOR AUIObject::GetColor(void)
{
	return m_color;
}
...
const char * AUIObject::GetCommand(void)
{
	return m_strCommand;
}

void AUIObject::SetCommand(const char *pszCommand)
{
	m_strCommand = pszCommand;
}

bool AUIObject::IsTransparent()
{
	return m_bTransparent;
}

void AUIObject::SetTransparent(bool bTransparent)
{
	m_bTransparent = bTransparent;
}

bool AUIObject::AcceptMouseMessage()
{
	return m_bAcceptMouseMsg;
}

void AUIObject::SetAcceptMouseMessage(bool bAccept)
{
	m_bAcceptMouseMsg = bAccept;
}
...
const ACHAR * AUIObject::GetHint()
{
	return m_szHint;
}

void AUIObject::SetHint(const ACHAR *pszHint)
{
	m_szHint = pszHint;
}

int AUIObject::GetHintMaxWidth()
{
	return m_nHintMaxWidth;
}

void AUIObject::SetHintMaxWidth(int nMaxWidth)
{
	m_nHintMaxWidth = nMaxWidth;
}

bool AUIObject::IsHintFollow()
{
	return m_bHintFollow;
}

void AUIObject::SetHintFollow(bool bHintFollow)
{
	m_bHintFollow = bHintFollow;
}

void AUIObject::BlinkText(bool bBlink)
{
	m_bBlinkText = bBlink;
}

int AUIObject::GetAlpha()
{
	return m_nAlpha;
}

void AUIObject::SetAlpha(int nAlpha)
{
	m_nAlpha = nAlpha;
	m_nOldAlpha = nAlpha;
}

int AUIObject::GetAlign()
{
	return m_nAlign;
}

void AUIObject::SetAlign(int nAlign)
{
	m_nAlign = nAlign;
}

bool AUIObject::GetFlash()
{
	return m_bFlash;
}
...
bool AUIObject::GetAnomaly()
{
	return m_bAnomaly;
}

void AUIObject::SetAnomaly(bool bAnomaly)
{
	m_bAnomaly = bAnomaly;
}

int AUIObject::GetLineSpace()
{
	return m_nLineSpace;
}
...
bool AUIObject::NeedDynamicRender()
{
	return m_bDynamicRender || m_bForceDynamicRender;
}
...
AString AUIObject::GetHoverSound()
{
	return m_strSoundHover;
}

A3DFTFont * AUIObject::GetFont()
{
	return m_pFont;
}

int AUIObject::GetFontHeight()
{
	return m_nFontHeight;
}

A3DViewport * AUIObject::GetClipViewport()
{
	return m_pA3DViewport;
}

void AUIObject::SetClipViewport(A3DViewport *pViewport)
{
...
void AUIObject::SetAutoIndent(bool bAutoIndent)
{
	m_bAutoIndent = bAutoIndent;
}

bool AUIObject::GetAutoIndent() const 
{
