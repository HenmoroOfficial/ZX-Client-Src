      ...
      Skill384Stub ():SkillStub (384)
        {
            occupation = 12;
            name = L"ËÄ´ó½Ô¿Õ£ºË®";
            nativename = "ËÄ´ó½Ô¿Õ£ºË®";
            icon = "ËÄ´ó½Ô¿Õ£ºË®.dds";
            maxlevel = 20;
            maxlearn = 8;
            type = 2;
            eventflag = 0;
            ...
            talent[2] = 691;
            talent_size = 3;
            action[0] = "ÌìÒôËÂ_ËÄ´ó½Ô¿ÕË®";
            action[1] = "ÌìÒôËÂ_ËÄ´ó½Ô¿ÕË®";
            action[2] = "ÌìÒôËÂ_ËÄ´ó½Ô¿ÕË®";
            action[3] = "ÌìÒôËÂ_ËÄ´ó½Ô¿ÕË®";
            action[4] = "ÌìÒôËÂ_ËÄ´ó½Ô¿ÕË®";
            action[5] = "ÌìÒôËÂ_ËÄ´ó½Ô¿ÕË®";
            action[6] = "";
            action[7] = "";
            action[8] = "";
            action[9] = "";
            ...
            action[13] = "";
            action[14] = "";
            action[15] = "ÌìÒôËÂ_Æï³Ë_ËÄ´ó½Ô¿ÕË®";
            action[16] = "ÌìÒôËÂ_Æï³Ë_ËÄ´ó½Ô¿ÕË®";
            action[17] = "ÌìÒôËÂ_Æï³Ë_ËÄ´ó½Ô¿ÕË®";
            action[18] = "ÌìÒôËÂ_Æï³Ë_ËÄ´ó½Ô¿ÕË®";
            action[19] = "ÌìÒôËÂ_Æï³Ë_ËÄ´ó½Ô¿ÕË®";
            action[20] = "ÌìÒôËÂ_Æï³Ë_ËÄ´ó½Ô¿ÕË®";
            action[21] = "";
            action[22] = "";
            action[23] = "";
            action[24] = "";
