      ...
      Skill4102Stub ():SkillStub (4102)
        {
            ...
            talent[1] = 1582;
            talent_size = 2;
            action[0] = "¹íµÀ_·¨±¦_ËÄÏñ·ğËş";
            action[1] = "ÇàÔÆÃÅ_·¨±¦_ËÄÏñ·ğËş";
            action[2] = "¹íÍõ×Ú_·¨±¦_ËÄÏñ·ğËş";
            action[3] = "ºÏ»¶ÅÉ_·¨±¦_ËÄÏñ·ğËş";
            action[4] = "ÌìÒôËÂ_·¨±¦_ËÄÏñ·ğËş";
            action[5] = "¹íµÀ_·¨±¦_ËÄÏñ·ğËş";
            action[6] = "·ÙÏã¹È_·¨±¦_ËÄÏñ·ğËş";
            action[7] = "ÊŞÉñ_·¨±¦_ËÄÏó·ğËş";
            action[8] = "ºüÑı_·¨±¦_ËÄÏó·ğËş";
            action[9] = "ĞùÔ¯_·¨±¦_ËÄÏó·ğËş";
            action[10] = "»³¹â_·¨±¦_ËÄÏó·ğËş";
            action[11] = "Ì«ê»_·¨±¦_ËÄÏó·ğËş";
            action[12] = "Ìì»ª_·¨±¦_ËÄÏó·ğËş";
            action[13] = "ÁéÙí_·¨±¦_ËÄÏó·ğËş";
            action[14] = "Ó¢ÕĞ_·¨±¦_ËÄÏó·ğËş";
            action[15] = "¹íµÀ_Æï³Ë_·¨±¦_ËÄÏñ·ğËş";
            action[16] = "ÇàÔÆÃÅ_Æï³Ë_·¨±¦_ËÄÏñ·ğËş";
            action[17] = "¹íÍõ×Ú_Æï³Ë_·¨±¦_ËÄÏñ·ğËş";
            action[18] = "ºÏ»¶ÅÉ_Æï³Ë_·¨±¦_ËÄÏñ·ğËş";
            action[19] = "ÌìÒôËÂ_Æï³Ë_·¨±¦_ËÄÏñ·ğËş";
            action[20] = "¹íµÀ_Æï³Ë_·¨±¦_ËÄÏñ·ğËş";
            action[21] = "·ÙÏã¹È_Æï³Ë_·¨±¦_ËÄÏñ·ğËş";
            action[22] = "ÊŞÉñ_Æï³Ë_·¨±¦_ËÄÏó·ğËş";
            action[23] = "ºüÑı_Æï³Ë_·¨±¦_ËÄÏó·ğËş";
            action[24] = "ĞùÔ¯_Æï³Ë_·¨±¦_ËÄÏó·ğËş";
            action[25] = "»³¹â_Æï³Ë_·¨±¦_ËÄÏó·ğËş";
            action[26] = "Ì«ê»_Æï³Ë_·¨±¦_ËÄÏó·ğËş";
            action[27] = "Ìì»ª_Æï³Ë_·¨±¦_ËÄÏó·ğËş";
            action[28] = "ÁéÙí_Æï³Ë_·¨±¦_ËÄÏó·ğËş";
            action[29] = "Ó¢ÕĞ_Æï³Ë_·¨±¦_ËÄÏó·ğËş";
            action[30] = "0";
            rangetype = 0;
            doenchant = true;
            dobless = true;
