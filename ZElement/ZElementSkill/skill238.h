      ...
      Skill238Stub ():SkillStub (238)
        {
            ...
            talent[3] = 617;
            talent_size = 4;
            action[0] = "ÇàÔÆÃÅ_ÎåÀ×ºä¶¥";
            action[1] = "ÇàÔÆÃÅ_ÎåÀ×ºä¶¥";
            action[2] = "ÇàÔÆÃÅ_ÎåÀ×ºä¶¥";
            action[3] = "ÇàÔÆÃÅ_ÎåÀ×ºä¶¥";
            action[4] = "ÇàÔÆÃÅ_ÎåÀ×ºä¶¥";
            action[5] = "ÇàÔÆÃÅ_ÎåÀ×ºä¶¥";
            action[6] = "";
            action[7] = "";
            action[8] = "";
            action[9] = "";
            ...
            action[13] = "";
            action[14] = "";
            action[15] = "ÇàÔÆÃÅ_Æï³Ë_ÎåÀ×ºä¶¥";
            action[16] = "ÇàÔÆÃÅ_Æï³Ë_ÎåÀ×ºä¶¥";
            action[17] = "ÇàÔÆÃÅ_Æï³Ë_ÎåÀ×ºä¶¥";
            action[18] = "ÇàÔÆÃÅ_Æï³Ë_ÎåÀ×ºä¶¥";
            action[19] = "ÇàÔÆÃÅ_Æï³Ë_ÎåÀ×ºä¶¥";
            action[20] = "ÇàÔÆÃÅ_Æï³Ë_ÎåÀ×ºä¶¥";
            action[21] = "";
            action[22] = "";
            action[23] = "";
            action[24] = "";
