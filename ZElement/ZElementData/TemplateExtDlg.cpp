...
CTemplateExtDlg::CTemplateExtDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CTemplateExtDlg::IDD, pParent), m_bOverseasEnable( false )
{
...
BOOL CTemplateExtDlg::OnInitDialog() 
{
	...
	if(m_bModified)
	{
		...
		m_nItemNum = m_extTmp.GetItemNum() - 1;
	...
	//添加控制海外模板ID输入框置灰功能 Added 2011-04-19.
	if ( m_bOverseasEnable ) //启用海外ID预留
	{
