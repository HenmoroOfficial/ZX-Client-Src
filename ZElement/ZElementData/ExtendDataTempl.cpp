...
bool ExtendDataTempl::CreateTempl(const char* szPath, const char* szExtName, BaseDataIDManBase* pIDMan, bool bNew, unsigned long ulTemplID)
{
	if (bNew)
	{
		m_strName = szExtName;
		//添加海外ID预留相关代码Modified 2011-04-19.
		unsigned long ulID = 0;
		if ( g_bOverseasEnable ) //启用海外ID预留
		{
