...
public:
	...
	void AlignTo(AUIDialog *pBase, int nInsideX, int nAlignX,
		int nInsideY, int nAlignY, int nOffsetX = 0, int nOffsetY = 0);
	void Blink(int nInterval);		// Zero is disable blinking.
	...
	void SetCaptureObject(PAUIOBJECT pObject);
	...
	bool IsDefaultShow(void);
	bool IsModal(void);
	bool IsActive();
	bool IsBackgroundDialog();
	bool IsCapture(void);
	bool IsCanMove();
	bool IsCanChangeZOrder();
	bool IsNoFlush() { return m_bNoFlush; }
	bool IsCanOutOfWindow();
	bool IsCanEscClose();
	...
	AUIManager * GetAUIManager();
	AUISubDialog * GetParentDlgControl();
	...
	bool GetImageCoverOrderly();
	int GetCurImageCover();
	int GetMinDistDlgRToScrL();
	int GetMinDistDlgLToScrR();
	int GetMinDistDlgBToScrT();
	int GetMinDistDlgTToScrB();
	...
	*/
	...
	void SetA3DEngine(A3DEngine *pA3DEngine);
	void SetA3DDevice(A3DDevice *pA3DDevice);
	...
	void SetText(const ACHAR *pszText);
	void SetIsModal(bool bModal);
	void SetIsDefaultShow(bool bShow);
	void SetBackgroundDialog(bool bBackgroundDialog);
	void SetCanMove(bool bCanMove);
	void SetCanChangeZOrder(bool bCanChangeZOrder);
	void SetAlpha(int nAlpha);
	void SetWholeAlpha(int nWholeAlpha);
	void SetDestroyFlag(bool bFlag);
	void SetLife(DWORD dwLife);
	void SetNoFlush(bool bNoFlush);
	void SetCanOutOfWindow(bool bCanOut);
	void SetMinDistDlgRToScrL(int iDist);
	void SetMinDistDlgLToScrR(int iDist);
	void SetMinDistDlgBToScrT(int iDist);
	void SetMinDistDlgTToScrB(int iDist);
	void SetCanEscClose(bool bCanEsc);
	...
	void SetAUIManager(AUIManager *pAUIManager);
	void SetParentDlgControl(AUISubDialog *pAUISubDialog);
	...
	void SetImageCoverOrderly(bool bOrderly);
	...
	PAUIOBJECTLISTELEMENT GetFirstControl(void);
	PAUIOBJECTLISTELEMENT GetNextControl(PAUIOBJECTLISTELEMENT pThis);
	PAUIOBJECTLISTELEMENT GetLastControl(void);
	PAUIOBJECTLISTELEMENT GetPrevControl(PAUIOBJECTLISTELEMENT pThis);
	PAUIOBJECT GetCaptureObject();
	...
	bool NeedUpdateRenderTarget() const { return m_bUpdateRenderTarget; }
