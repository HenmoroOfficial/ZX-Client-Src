...
#ifdef _ANGELICA22
	virtual void Update (A3DTerrain2 *pTerrain,A3DTerrainWater2 *pTerrainWater,A3DAutonomousGroup* pGroup, DWORD dwDeltaTime) {}
#else
...
#ifdef _ANGELICA22
	void Update (A3DTerrain2 *pTerrain,A3DTerrainWater2 *pTerrainWater,A3DAutonomousGroup * pGroup, DWORD dwDeltaTime);
#else
...
#ifdef _ANGELICA22
	void FleeProcess(A3DTerrain2 *pTerrain, A3DTerrainWater2 *pTerrainWater, A3DAutonomousGroup * pGroup, DWORD dwDeltaTime);
	void BackProcess(A3DTerrain2 *pTerrain, A3DTerrainWater2 *pTerrainWater, A3DAutonomousGroup * pGroup, DWORD dwDeltaTime);
#else
