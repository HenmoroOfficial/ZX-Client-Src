...
#ifdef _ANGELICA22
void A3DAutoBehaviourWander::Update (A3DTerrain2 *pTerrain,A3DTerrainWater2 *pTerrainWater, A3DAutonomousGroup * pGroup, DWORD dwDeltaTime)
#else
...
#ifdef _ANGELICA22
void A3DAutoBehaviourHover::Update (A3DTerrain2 *pTerrain,A3DTerrainWater2 *pTerrainWater,A3DAutonomousGroup * pGroup, DWORD dwDeltaTime)
#else
...
#ifdef _ANGELICA22
void A3DAutoBehaviourBoid::Update (A3DTerrain2 *pTerrain,A3DTerrainWater2 *pTerrainWater,A3DAutonomousGroup * pGroup, DWORD dwDeltaTime)
#else
...
#ifdef _ANGELICA22
void A3DAutoBehaviourArrival::Update (A3DTerrain2 *pTerrain,A3DTerrainWater2 *pTerrainWater,A3DAutonomousGroup * pGroup, DWORD dwDeltaTime)
#else
...
#ifdef _ANGELICA22
void A3DAutoBehaviourFlee::Update (A3DTerrain2 *pTerrain,A3DTerrainWater2 *pTerrainWater,A3DAutonomousGroup * pGroup, DWORD dwDeltaTime)
#else
...
#ifdef _ANGELICA22
void A3DAutoBehaviourFleeAndBack::Update (A3DTerrain2 *pTerrain,A3DTerrainWater2 *pTerrainWater,A3DAutonomousGroup * pGroup, DWORD dwDeltaTime)
#else
...
#ifdef _ANGELICA22
void A3DAutoBehaviourFleeAndBack::FleeProcess(A3DTerrain2 *pTerrain, A3DTerrainWater2 *pTerrainWater, A3DAutonomousGroup * pGroup, DWORD dwDeltaTime)
#else
...
#ifdef _ANGELICA22
void A3DAutoBehaviourFleeAndBack::BackProcess(A3DTerrain2 *pTerrain, A3DTerrainWater2 *pTerrainWater, A3DAutonomousGroup * pGroup, DWORD dwDeltaTime)
#else
