...
public:
	 ...
	 */
	static	int  GetChildTex(int iLevel, int iSubIndex, int iChild[], const int OUTLINE_TEX_LEVEL[]);// 把全局数组OUTLINE_TEX_LEVEL修改为成员属性, 2013.4.26 wuweixin
	static  int  GetParentTex(int iLevel, int iSubIndex, const int OUTLINE_TEX_LEVEL[]);// 把全局数组OUTLINE_TEX_LEVEL修改为成员属性, 2013.4.26 wuweixin
...
extern int EXTERN_OUTLINE_TEX_LEVEL[];
