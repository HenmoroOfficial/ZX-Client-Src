...
bool CELGrassLand::Init(A3DDevice * pA3DDevice, A3DTerrain2 * pTerrain, ALog * pLogFile)
{
	...
	m_pGrassVertexShader = m_pA3DDevice->GetA3DEngine()->GetA3DShaderMan()->LoadVertexShader("Shaders\\vs\\grass_wave.txt", false, dwVSDecl);
...
#ifdef _ANGELICA22
#else
	m_pGrassRefractVertexShader = m_pA3DDevice->GetA3DEngine()->GetA3DShaderMan()->LoadVertexShader("Shaders\\vs\\grass_wave_refract.txt", false, dwVSDecl);
...
bool CELGrassLand::Render(A3DViewport * pViewport, bool bRenderAlpha)
{
...
#ifdef _ANGELICA22
		m_pA3DDevice->SetClipPlane(0, (float*) &hcp);
#else
	...
	{
#ifdef _ANGELICA22
		m_pA3DDevice->SetClipPlane(0, (float*) &cp);
#else
