...
bool CELOutlineQuadTree::Init(A3DDevice * pDevice , int iSubIndex, float wx, float wz, const int OUTLINE_TEX_LEVEL[])// 把全局数组OUTLINE_TEX_LEVEL修改为成员属性, 2013.4.26 wuweixin
{
