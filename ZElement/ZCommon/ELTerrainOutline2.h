...
private:
	...
	int					m_OUTLINE_TEX_LEVEL[OUTLINE_MAX_LEVEL*2]; // 把全局数组OUTLINE_TEX_LEVEL修改为成员属性, 2013.4.26 wuweixin
...
public:
	 ...
	 *  @author kuiwu
	 */
	bool Init(A3DDevice * pA3DDevice, const char * szTexDir, const char * szTileDir, const char * szDetailTex, A3DTerrain2 * pTerrain2, unsigned int nWTileCount = 8, unsigned int nHTileCount = 11);
	void Release();
	...
	const int* GetOUTLINE_TEX_LEVEL() const { return m_OUTLINE_TEX_LEVEL; }
};
