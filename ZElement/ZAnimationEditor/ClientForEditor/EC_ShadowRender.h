...
public:
	...
	bool AddShadower(const A3DVECTOR3& vecCenter, const A3DAABB& aabb, SHADOW_RECEIVER shadowReceiver, LPRENDERFORSHADOW pfnRenderForShadow, LPVOID pArg, bool bSimpleShadow=true);
