...
#define SPRITE_NO_RENDER_TIME	2500
...
public:		//	Constructor and Destructor
	...
	inline void SetNoRender(bool b)
	{
		m_bNoRender = b;
		m_dwNoRenderTime = (b ? SPRITE_NO_RENDER_TIME : 0);
	}

public:		//	Operations

	//	Initialize object
	bool Init(CECPlayer * pPlayer, CECModel* pModel);
	//	Release object
	void Release();
