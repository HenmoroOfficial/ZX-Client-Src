...
*/
	...
	typedef abase::hash_map<AString, AString> ConfigMap;
...
*/
	void SetTooltype(int t) { m_iToolType = t; }
	int GetToolType() { return m_iToolType; }
