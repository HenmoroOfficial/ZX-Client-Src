...
protected:
	...
	void ProcessGfx(CSceneObject *pObj ,CElementMap *pMap, A3DGFXEx *pGfxEx);
#ifdef _ANGELICA22
#else
	...
	void ProcessArea(CSceneObject *pObj ,CElementMap *pMap);
	...
	afx_msg void OnRadioSize2048();
	afx_msg void OnRadioSize4096();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
