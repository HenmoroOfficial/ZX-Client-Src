...
protected:
	...
	afx_msg void OnCheckShowBoundbox();
	afx_msg void OnSelectedAll();
	afx_msg void OnSelectedNull();
	afx_msg void OnCheckPickBuffRegion();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedCheckCameraFollow();
	afx_msg void OnBnClickedCheckNeighbourTerrainOnly();
};
