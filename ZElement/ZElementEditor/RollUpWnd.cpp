...
#else
void CRollUpWnd::OnRollUpTitleClick(WPARAM wParam, LPARAM lParam)
...
#else
void CRollUpWnd::OnRollUpBeginDrag(WPARAM wParam, LPARAM lParam)
#endif // #ifdef _ANGELICA22
{
	//	Begin drag slide
	BeginDrag();
...
#else
void CRollUpWnd::OnRollUpRollDown(WPARAM wParam, LPARAM lParam)
#endif // #ifdef _ANGELICA22
{
	RollDown(-(int)wParam);
#ifdef _ANGELICA22
...
#else
void CRollUpWnd::OnRollUpPopupMenu(WPARAM wParam, LPARAM lParam)
#endif // #ifdef _ANGELICA22
{
...
BOOL CRollUpWnd::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt)
{
	// TODO: Add your message handler code here and/or call default
	m_ScrollBar.RollDown(-zDelta, false);
