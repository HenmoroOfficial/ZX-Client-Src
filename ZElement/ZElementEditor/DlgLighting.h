...
public:		//	Types
	...
	struct INITDATA
	{
        ...
        DWORD		dwAmbient2;	//	Ambient color
        ...
        DWORD		dwNightAmbient2;//	Ambient color
...
public:
	...
	static bool ImportLitInfo(const char* szFileName, LIGHTINGPARAMS& paramDay, LIGHTINGPARAMS& paramNight);
	static bool ExportLitInfo(const char* szFileName, const LIGHTINGPARAMS& paramDay, const LIGHTINGPARAMS& paramNight);
...
protected:
    ...
    float   fMaxLight;          //  Max Light power
    ...
    float   fNightMaxLight;          //  Max Light power
...
protected:
    ...
    afx_msg void OnStnClickedStaticAmbient();
    afx_msg void OnEnChangeEditSunpower2();
    afx_msg void OnEnChangeEditAmbient2();
    afx_msg void OnEnChangeEditAmbientpower();
	//}}AFX_MSG
