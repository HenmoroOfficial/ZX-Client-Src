...
public:
	...
	virtual void MovePlant(int id,A3DVECTOR3 vDelta){};
...
#ifdef _ANGELICA22
	void          SetGrassType(A3DGrassType *pGrassType){ m_pGrassType = pGrassType;};
	A3DGrassType* GetGrassType(){ return m_pGrassType; };
#else
...
public:
	...
	PPLANT AddPlant(const AString& name,int nID,int nType);
	void DeletePlant(const AString& name);
