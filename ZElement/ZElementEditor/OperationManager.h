...
enum
{
		...
		OPERATION_TERRAIN_OBSTRUCT3,
		OPERATION_BRUSH_TREE,
		OPERATION_SCENE_BUFF_REGION_ADD,
		OPERATION_TERRAIN_COLORMAP,
		OPERATION_TERRAIN_COLOR_SMOOTH,
		OPERATION_SCENE_GUILDBUILDING,
