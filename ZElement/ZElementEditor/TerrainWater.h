...
#ifdef _ANGELICA22
	A3DTerrainWater2* GetA3DTerrainWater(){ return m_pA3DTerrainWater; };

protected:	//	Attributes
	bool m_bExportOnly;

	// an array to store all water areas information
	APtrArray<A3DWaterArea2 *> * m_pWaterAreas;

	CElementMap*	m_pMap;				//	Map object
	A3DTerrainWater2*m_pA3DTerrainWater;//	Water object
#else
...
#ifdef _ANGELICA22
	A3DWaterArea2* GetWaterArea(int index);
