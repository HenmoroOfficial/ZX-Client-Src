...
!MESSAGE 
!MESSAGE NMAKE /f "ElementEditor.mak" CFG="ElementEditor - Win32 Debug"
!MESSAGE 
...
!MESSAGE "ElementEditor - Win32 DBGRelease" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /nologo /MDd /Gm /GX /ZI /Od /I ".\\" /I "\Property" /I ".\PathMap" /I "..\Include\CD" /I "..\Include\wintab" /I "..\Include" /I "..\ZCommon" /I "..\..\Angelica2\Output\AFSDK\Include" /I "..\..\Angelica2\Output\ACSDK\Include" /I "..\..\Angelica2\Output\AMSDK\Include" /I "..\..\Angelica2\Output\3rdSDK\Include" /I "F:\DirectX 8.1 SDK\Include" /I "..\include" /I "..\..\Angelica2\Output\A3DSDK\Include" /I "..\ZCommon\Gfx" /I "..\ZCommon\autoca" /I "..\ZCommon\Face" /I "..\Include\luawrapper" /I "..\include\gfx" /I "..\include\stlport" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /D "_MODEDITOREX" /D "_ELEMENT_EDITOR_" /D "GFX_EDITOR" /D "BACK_VERSION" /YX /FD /GZ /c
...
# ADD LINK32 DdsTrans.lib CHBasedCD_d.lib Imm32.lib mpg123lib_d.lib Immwrapper_d.lib AngelicaCommon_d.lib AngelicaMedia_d.lib AngelicaFile_d.lib Angelica3D_d.lib zliblib.lib dxguid.lib d3d8.lib d3dx8.lib dsound.lib dinput8.lib shlwapi.lib dxerr8.lib SpeedTreeRT_d.lib lua5.1.mtd.lib gfxeditor_d.lib wintab32.lib luawrapper_d.lib vorbisfile_static_d.lib vorbis_static_d.lib ogg_static_d.lib asynbase.lib APhysXEngineStatic_d.lib PhysXLoader.lib NxCooking.lib NxCharacter.lib propdlg_d.lib /nologo /subsystem:windows /incremental:no /debug /machine:I386 /out:"..\ZBin\ZElementEditor_d.exe" /pdbtype:sept /libpath:"..\Lib\CD" /libpath:"..\Lib" /libpath:"..\..\Angelica2\Output\A3DSDK\Lib" /libpath:"..\..\Angelica2\Output\AFSDK\Lib" /libpath:"..\..\Angelica2\Output\ACSDK\Lib" /libpath:"..\..\Angelica2\Output\AMSDK\Lib" /libpath:"..\..\Angelica2\Output\3rdSDK\Lib" /libpath:"F:\DirectX 8.1 SDK\lib" /libpath:"..\lib\lua" /libpath:"..\lib\wintab" /libpath:"..\lib\stlport"
...
# ADD CPP /nologo /MD /W3 /GX /O2 /Ob2 /I ".\\" /I "\Property" /I "\PathMap" /I "..\Include\CD" /I "..\Include\wintab" /I "..\Include" /I "..\ZCommon" /I "..\ZCommon\Gfx" /I "..\ZCommon\autoca" /I "..\ZCommon\Face" /I "..\..\Angelica2\Output\A3DSDK\Include" /I "..\..\Angelica2\Output\AFSDK\Include" /I "..\..\Angelica2\Output\ACSDK\Include" /I "..\..\Angelica2\Output\AMSDK\Include" /I "..\..\Angelica2\Output\3rdSDK\Include" /I "F:\DirectX 8.1 SDK\Include" /I "..\include" /I "..\Include\luawrapper" /I "..\include\gfx" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_MODEDITOREX" /D "_AFXDLL" /D "_ELEMENT_EDITOR_" /D "GFX_EDITOR" /D "BACK_VERSION" /YX /FD /c
...
# ADD LINK32 DdsTrans.lib CHBasedCD.lib Imm32.lib mpg123lib.lib Immwrapper.lib AngelicaCommon.lib AngelicaMedia.lib AngelicaFile.lib Angelica3D.lib zliblib.lib dxguid.lib d3d8.lib d3dx8.lib dsound.lib dinput8.lib shlwapi.lib SpeedTreeRT.lib lua5.1.mt.lib gfxeditor.lib wintab32.lib luawrapper.lib strmbase.lib vorbisfile_static.lib vorbis_static.lib ogg_static.lib asynbase.lib APhysXEngineStatic.lib PhysXLoader.lib NxCooking.lib NxCharacter.lib stlport_vc6_static.lib propdlg.lib /nologo /subsystem:windows /machine:I386 /out:"..\ZBin\ZElementEditor.exe" /libpath:"..\Lib\CD" /libpath:"..\Lib" /libpath:"..\..\Angelica2\Output\A3DSDK\Lib" /libpath:"..\..\Angelica2\Output\AFSDK\Lib" /libpath:"..\..\Angelica2\Output\ACSDK\Lib" /libpath:"..\..\Angelica2\Output\AMSDK\Lib" /libpath:"..\..\Angelica2\Output\3rdSDK\Lib" /libpath:"F:\DirectX 8.1 SDK\lib" /libpath:"..\lib\lua" /libpath:"..\lib\wintab" /libpath:"..\lib\stlport"
# SUBTRACT LINK32 /incremental:yes /debug /nodefaultlib

!ELSEIF  "$(CFG)" == "ElementEditor - Win32 DBGRelease"

# PROP BASE Use_MFC 6
# PROP BASE Use_Debug_Libraries 0
# PROP BASE Output_Dir "ElementEditor___Win32_DBGRelease"
# PROP BASE Intermediate_Dir "ElementEditor___Win32_DBGRelease"
# PROP BASE Ignore_Export_Lib 0
# PROP BASE Target_Dir ""
# PROP Use_MFC 6
# PROP Use_Debug_Libraries 0
# PROP Output_Dir "ElementEditor___Win32_DBGRelease"
# PROP Intermediate_Dir "ElementEditor___Win32_DBGRelease"
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MD /W3 /GX /Zi /O2 /Ob2 /I ".\\" /I "\Property" /I "\PathMap" /I "..\Include\CD" /I "..\Include\wintab" /I "..\Include" /I "..\ZCommon" /I "..\ZCommon\Gfx" /I "..\ZCommon\autoca" /I "..\ZCommon\Face" /I "..\..\Angelica2\Output\A3DSDK\Include" /I "..\..\Angelica2\Output\AFSDK\Include" /I "..\..\Angelica2\Output\ACSDK\Include" /I "..\..\Angelica2\Output\AMSDK\Include" /I "..\..\Angelica2\Output\3rdSDK\Include" /I "F:\DirectX 8.1 SDK\Include" /I "..\include" /I "..\Include\luawrapper" /I "..\include\gfx" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_MODEDITOREX" /D "_AFXDLL" /D "_ELEMENT_EDITOR_" /D "GFX_EDITOR" /YX /FD /c
# ADD CPP /nologo /MD /W3 /GX /Zi /O2 /Ob2 /I ".\\" /I "\Property" /I "\PathMap" /I "..\Include\CD" /I "..\Include\wintab" /I "..\Include" /I "..\ZCommon" /I "..\ZCommon\Gfx" /I "..\ZCommon\autoca" /I "..\ZCommon\Face" /I "..\..\Angelica2\Output\A3DSDK\Include" /I "..\..\Angelica2\Output\AFSDK\Include" /I "..\..\Angelica2\Output\ACSDK\Include" /I "..\..\Angelica2\Output\AMSDK\Include" /I "..\..\Angelica2\Output\3rdSDK\Include" /I "F:\DirectX 8.1 SDK\Include" /I "..\include" /I "..\Include\luawrapper" /I "..\include\gfx" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_MODEDITOREX" /D "_AFXDLL" /D "_ELEMENT_EDITOR_" /D "GFX_EDITOR" /D "BACK_VERSION" /YX /FD /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x804 /d "NDEBUG" /d "_AFXDLL"
# ADD RSC /l 0x804 /d "NDEBUG" /d "_AFXDLL"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 DdsTrans.lib CHBasedCD.lib Imm32.lib mpg123lib.lib Immwrapper.lib AngelicaCommon.lib AngelicaMedia.lib AngelicaFile_drsb.lib Angelica3D.lib zliblib.lib dxguid.lib d3d8.lib d3dx8.lib dsound.lib dinput8.lib shlwapi.lib SpeedTreeRT.lib lua5.1.mt.lib gfxeditor.lib wintab32.lib luawrapper.lib strmbase.lib vorbisfile_static.lib vorbis_static.lib ogg_static.lib asynbase.lib APhysXEngineStatic.lib PhysXLoader.lib NxCooking.lib NxCharacter.lib /nologo /subsystem:windows /debug /machine:I386 /out:"..\ZBin\ZElementEditor.exe" /libpath:"..\Lib\CD" /libpath:"..\Lib" /libpath:"..\..\Angelica2\Output\A3DSDK\Lib" /libpath:"..\..\Angelica2\Output\AFSDK\Lib" /libpath:"..\..\Angelica2\Output\ACSDK\Lib" /libpath:"..\..\Angelica2\Output\AMSDK\Lib" /libpath:"..\..\Angelica2\Output\3rdSDK\Lib" /libpath:"F:\DirectX 8.1 SDK\lib" /libpath:"..\lib\lua" /libpath:"..\lib\wintab"
...
# Name "ElementEditor - Win32 DBGRelease"
...
SOURCE=.\SceneBuffRegion.cpp
# End Source File
# Begin Source File

SOURCE=.\SceneBuffRegion.h
# End Source File
# Begin Source File
...
SOURCE=.\PathMap\PlayerAirPassMapGenerator.cpp
# End Source File
# Begin Source File

SOURCE=.\PathMap\PlayerAirPassMapGenerator.h
# End Source File
# Begin Source File
...
SOURCE=..\ZCommon\Gfx\A3DSkillGfxComposer.h
# End Source File
# Begin Source File

SOURCE=..\ZCommon\Gfx\A3DSkillGfxEvent.h
# End Source File
# End Group
# Begin Group "Autoca"
...
SOURCE=".\BrushTreeOperation .h"
# End Source File
# Begin Source File

SOURCE=.\BrushTreeOperation.cpp
# End Source File
# Begin Source File
...
SOURCE=".\ObstructOperation3 .h"
# End Source File
# Begin Source File

SOURCE=.\ObstructOperation3.cpp
# End Source File
# Begin Source File
...
SOURCE=.\FloatInputDlg.cpp
# End Source File
# Begin Source File

SOURCE=.\FloatInputDlg.h
# End Source File
# Begin Source File
...
SOURCE=.\BezierPointBar.cpp
# End Source File
# Begin Source File

SOURCE=.\BezierPointBar.h
# End Source File
# Begin Source File
...
SOURCE=.\ExtraAreaManDlg.cpp
# End Source File
# Begin Source File

SOURCE=.\ExtraAreaManDlg.h
# End Source File
# Begin Source File

SOURCE=.\ExtraSelDlg.cpp
# End Source File
# Begin Source File

SOURCE=.\ExtraSelDlg.h
# End Source File
# Begin Source File
...
SOURCE=.\ImportFromHistroy.h
# End Source File
# Begin Source File

SOURCE=.\ImportTimeDlg.cpp
# End Source File
# Begin Source File

SOURCE=.\ImportTimeDlg.h
# End Source File
# Begin Source File
...
SOURCE=.\timeseg_real.cpp
# End Source File
# Begin Source File

SOURCE=.\timeseg_real.h
# End Source File
# Begin Source File
