...
protected:	//	Attributes
	...
	T2LMFILEHEADER2		m_CMFileHeader;		//	Light map file header
#endif // #ifdef _ANGELICA22
...
#ifdef _ANGELICA22
	//	Allocate exporting vertex color light map resources
	bool ExportProjectVertexColorMap(CExpTerrain* pTerrain, int iMaskArea, int iRow, int iCol);
	bool AllocVertexColorMapExportRes();
	void ReleaseVertexColorMapExportRes();
#endif // #ifdef _ANGELICA22
};
