...
#else
	//	WM_ROLLUPTITLECLICK handler
	afx_msg void OnRollUpTitleClick(WPARAM wParam, LPARAM lParam);
	//	WM_ROLLUPBEGINDRAG handler
	afx_msg void OnRollUpBeginDrag(WPARAM wParam, LPARAM lParam);
	//	WM_ROLLUPROLLDOWN handler
	afx_msg void OnRollUpRollDown(WPARAM wParam, LPARAM lParam);
	//	WM_ROLLUPPOPUPMENU handler
	afx_msg void OnRollUpPopupMenu(WPARAM wParam, LPARAM lParam);
