...
public:
	inline void SetWorldInfo(A3DCOLOR clAmbient,A3DCOLOR clAmbient2,const A3DVECTOR3& vecSunDir, const A3DCOLORVALUE& clSun, float vSunPower, const A3DVECTOR3& vecWorldCenter,
