...
bool CCoordinateDirection::TraceAxis(const A3DVECTOR3& vAxis,const A3DVECTOR3& vStart,const A3DVECTOR3& vEnd, float& dis)
{
	A3DVECTOR3 Vertices[2];
	Vertices[0] =  A3DVECTOR3(0,0,0);
	Vertices[1] =  vAxis;
...
bool CCoordinateDirection::TracePlane(A3DVECTOR3* pVertices, const A3DVECTOR3& vStart,const A3DVECTOR3& vEnd, float& dis)
{
