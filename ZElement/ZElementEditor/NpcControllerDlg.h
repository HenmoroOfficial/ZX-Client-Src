...
protected:
	...
	void SetTimeRangeType(bool bAnd);
	...
	afx_msg void OnTimeRangeEdit();
	afx_msg void OnTimeRangeDel();
	afx_msg void OnTimeRangeAdd3();
	afx_msg void OnDblclkListTimeRange(NMHDR* pNMHDR, LRESULT* pResult);
	afx_msg void OnRadioUnion();
	afx_msg void OnRadioAnd();
	afx_msg void OnTimeRangeCheck2();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
