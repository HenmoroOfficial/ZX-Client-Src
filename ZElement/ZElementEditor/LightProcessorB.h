...
#ifndef _LIGHTPROCESSORB_H_
#define _LIGHTPROCESSORB_H_
...
public:
	inline void SetWorldInfo(A3DCOLOR clAmbient,A3DCOLOR clAmbient2,const A3DVECTOR3& vecSunDir, const A3DCOLORVALUE& clSun, float vSunPower, float vAmbientPower, const A3DVECTOR3& vecWorldCenter,
		const A3DAABB& aabbWorld)
	{
		m_clAmbient			= clAmbient;
		m_clAmbient2		= clAmbient2;
		m_clAmbient2		*= vAmbientPower;
		m_vecSunDir			= vecSunDir;
		m_clSun				= clSun;
		m_vSunPower			= vSunPower;
		m_vAmbientPower		= vAmbientPower;
		m_vecWorldCenter	= vecWorldCenter;
		m_aabbWorld			= aabbWorld;
	}
};

#endif//_LIGHTPROCESSORB_H_