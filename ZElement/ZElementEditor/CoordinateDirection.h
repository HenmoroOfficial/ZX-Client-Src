...
private:
	...
	bool TraceAxis(const A3DVECTOR3& vAxis, const A3DVECTOR3& vStart, const A3DVECTOR3& vEnd, float& dis);
	bool TracePlane(A3DVECTOR3* pVertices, const A3DVECTOR3& vStart,const A3DVECTOR3& vEnd, float& dis);
