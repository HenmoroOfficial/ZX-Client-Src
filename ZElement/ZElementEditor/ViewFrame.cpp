...
{
	return m_RenderWnd.SendMessage(WM_KEYDOWN, wParam, lParam);
}
#else
void CViewFrame::OnKeyDown(WPARAM wParam, LPARAM lParam)
{
...
{
	return m_RenderWnd.SendMessage(WM_KEYUP, wParam, lParam);
}
#else
void CViewFrame::OnKeyUp(WPARAM wParam, LPARAM lParam)
{
...
BOOL CViewFrame::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt)
{
	// TODO: Add your message handler code here and/or call default
	m_RenderWnd.OnMouseWheel(nFlags, zDelta, pt);
