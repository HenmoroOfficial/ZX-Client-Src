...
protected:
	...
	afx_msg void OnCheckShowFixedNpcWire();
	...
	afx_msg void OnSelectedNull();

	afx_msg void OnShowWindow(BOOL bShow, UINT nStatus);
	//}}AFX_MSG
	
	afx_msg void OnBnClickedCheckRenderGlobalFog();
#ifdef _ANGELICA22
	...
	DECLARE_MESSAGE_MAP()
public:
	CButton m_ChkGlobalFlog;
	afx_msg void OnCbnSelchangeComboWaterQuality();
	afx_msg void OnBnClickedButtonCubemapLoad();
};
