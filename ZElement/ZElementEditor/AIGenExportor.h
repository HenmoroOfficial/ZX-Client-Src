...
public:		//	Types
	...
	struct NPCAREA
	{
		NPCGENFILEAREA14	Area;
		int					iFirstGen;
		AArray<int, int>	aAttachs;	//	Attaching area
	};

	//	Resource area
	struct RESAREA
	{
		NPCGENFILERESAREA14	Area;
		int					iFirstRes;
		AArray<int, int>	aAttachs;	//	Attaching area
	};
...
protected:	//	Attributes
	...
	APtrArray<NPCAREA*>								m_aExpNPCAreas;
	AArray<NPCGENFILEAIGEN, NPCGENFILEAIGEN&>		m_aExpNPCGens;
	APtrArray<RESAREA*>								m_aExpResAreas;
	AArray<NPCGENFILERES, NPCGENFILERES&>			m_aExpRes;
	AArray<NPCGENFILEDYNOBJ14, NPCGENFILEDYNOBJ14&>	m_aExpDynObjs;
	AArray<NPCGENFILECTRL13, NPCGENFILECTRL13&>		m_aExpCtrls;
	...
	REGIONFILEHEADER5	m_RGNFHeader;	//	Region file header
...
protected:	//	Operations
	...
	bool ExportGuildBuildings(CExpElementMap* pMap);
