...
public:
	...
	virtual void Tick(DWORD dwTickDelta, const A3DTrail::STrailPerturbParam& perturbParam) = 0;
...
protected:
	...
	virtual void Tick(DWORD dwTickDelta, const A3DTrail::STrailPerturbParam& perturbParam);
	virtual void Reset();
