...
#ifndef _A3D_SUNMOON_H_
#define _A3D_SUNMOON_H_
...
private:
    ...
    A3DHLSL*            m_pHLSLMain;
    A3DHLSL*            m_pHLSLTestOcc;
    A3DVertexDecl*      m_pVertDecl;
    A3DVertexDecl*      m_pTLVertDecl;
    A3DVertexDecl*      m_pOccTestDecl;
...
public:
	...
	A3DSunMoon(A3DDevice* pA3DDevice);
	~A3DSunMoon();
	...
	int GetDNTransTime();
    void SetDNFactor(float fDNFactor) { SetTimeOfTheDay((1 - fDNFactor) / 2); }

    A3DVECTOR3 ComputeSunDir() const;
};

#endif // _A3D_SUNMOON_H_
