...
public:
	...
	virtual void Tick(DWORD dwTickDelta, const GfxPerturbParam& perturbParam) = 0;
	virtual void Reset() = 0;
	virtual void SetSampleFreq(int iSampleFreq) {}
	virtual void PrepareRenderData(const A3DVECTOR3& vCamPos, bool bFaceCamera = false) {}
	virtual int GetRenderCount() const = 0;
	virtual void GetRenderTrailData(int iRenderIdx, TRAIL_DATA& td) const = 0;
	virtual TRAIL_DATA& GetRenderTrailData(int iRenderIdx) = 0;
...
protected:
	...
	virtual void Tick(DWORD dwTickDelta, const GfxPerturbParam& perturbParam);
	virtual void Reset();
	virtual int GetRenderCount() const;
	virtual void GetRenderTrailData(int iRenderIdx, TRAIL_DATA& td) const;
	virtual TRAIL_DATA& GetRenderTrailData(int iRenderIdx);
	virtual void SetSampleFreq(int iSampleFreq) 
	{ 
