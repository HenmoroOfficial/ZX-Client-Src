...
#define		ID_GFXOP_TRAIL_PERTURB			107
#define		ID_GFXOP_TRAIL_FACE_CAMERA	    108
...
#define		ID_GFXOP_LN_EX_PERTURB			205
...
enum eGfxPerturbMode
{
	eGfxPerturbMode_None = 0,
	eGfxPerturbMode_Spreading = 1
};

// // To support spreading effect of A3DTrail and A3DLightning. [3/26/2014 mage]
class GfxPerturbParam 
{
public:
	GfxPerturbParam()
		:m_iPerturbMode(eGfxPerturbMode_None)
	...
	void			Reset();
	void			AddSpreadDirection();
	void			ApplySpread(float fElapseTime, DWORD dwTickTime, int segIdx, A3DVECTOR3& vDestToApply) const;
	void			Save(AFile* pFile);
	void			Load(AFile* pFile);

	eGfxPerturbMode m_iPerturbMode;
...
public:
	...
	virtual GfxPerturbParam* GetPerturbParam() { return NULL; }
