//
// 从 skin_mesh_m4_s_tan.hlsl 复制,去掉了 Tangent 计算
//

#include "..\fog\fog_common.h"

string entrynames = "vs_3_0 vs_main";
// DESCRIPTION:
...
//*
	...
	blendTangent.xyz = float3(1,0,0);
	blendTangent.w = 1;

	blendBinormal.xyz = cross(blendNormal.xyz, blendTangent.xyz);
...
/*/
	...
	output.unknown = 1;
//*/
    output.fogParam = ComputeFog(output.pos.w, g_vecEyePos.y, pos.y);
