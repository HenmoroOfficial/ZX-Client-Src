...
#define ELEMENTDATA_VERSION			0x1000008a
...
struct PET_BEDGE_ESSENCE
{
	...
	int				file_matter;				// 掉在地上的模型路径
	int				file_icon;					// 图标路径
	int				file_head_icon[6];			// 头像图标
	int				file_to_shown[6];			// 不同星级形象
...
struct MONSTER_ESSENCE
{
	...
	unsigned int	immune_type;				// 免疫类型，为Mask组合方式，各位的含义从低到高依次为：
												...
												// 免疫持续伤害、免疫嘲讽、免疫元神耗散、免疫流魔、免疫变身、免疫灼烧
...
struct NPC_ESSENCE
{
	...
	unsigned int	id_item_trade_service;		// 物物交易服务
	...
	unsigned int	combined_services2;			// 简单服务组合：其中的每一位代表一个不需要参数的服务：
												...
												// 25: 跨服小队pk红队报名; 26: 跨服小队pk蓝队报名; 27: 跨服小队pk记者报名; 28: 副本相关服务;
	// 洗PK值服务
